...
$\mathsf{}$$\mathsf{FPT} \subsetneq W[1] = A[1]$

$W[i]\subseteq A[i],W[i]\subseteq W[i+1],A[i]\subseteq A[i+1]$

$W[P]\subseteq \mathsf{XP} \cap \mathsf{para-NP}$

$A[P]\subseteq \mathsf{XP} \cap \mathsf{para-NP}$
