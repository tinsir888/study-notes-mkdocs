...
$\varphi::=A|B|\cdots|(\varphi)|\neg\varphi|\varphi\and\varphi|\varphi\or\varphi|\varphi\Rightarrow\varphi|\varphi\Leftrightarrow\varphi|\varphi\oplus\varphi$
...
$$
For example: $\varphi=A\or(B\to(A\and C))$ has $8$ possible truth assignments.
...
$$
{\varphi\ \psi\over\varphi\and\psi}(\and\text{-I})
$$

$$
{\varphi\and\psi\over\varphi}(\and\text{-E1})
$$

$$
{\varphi\and\psi\over\psi}(\and\text{-E2})
$$
